...
public class PlaylistnowController {
	...
	*/
	@ResponseBody
	@PostMapping("/add")
	public List<PlaylistnowDto> AddSongMyPlaylist(@RequestParam("add_song") String songName) {
	...
	*/
	@ResponseBody
	@GetMapping("/shuffle")
	public List<PlaylistnowDto> ShuffleMyPlaylist() {
		List<PlaylistnowDto> pd = playlistnowService.getMyPlaylistShuffle("tkdldjs985");
		List<Integer> songId = songService.getSongIds(pd);
		int playlistCd = playlistnowService.getPlaylistCd("tkdldjs985");
