...
public class GenreController {
	...
	*/
	...
	public List<SongDto> getByGenreByEraSong(@PathVariable ("choiceEra") String choiceEra, @RequestParam("genreName") String genreName) {
	...
	*/
	...
	public List<AlbumDto> getByGenreByEraAlbum(@PathVariable ("choiceEra") String choiceEra, @RequestParam("genreName") String genreName) {
