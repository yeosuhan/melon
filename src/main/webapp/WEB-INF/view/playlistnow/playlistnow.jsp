...
<link href="<%=request.getContextPath()%>/resources/css/playlistnow.css" rel="stylesheet">
<body>
<%@ include file="/WEB-INF/view/common/header.jsp" %>
<script src="<%=request.getContextPath()%>/resources/js/playlist.js"></script>
<section class="sec1">
    ...
    <div class="wrap">
        ...
        <div class="playlistnow_list_wrap">
			<table class="playlistnow_list">
				<thead>
					<tr>
				...
				<tbody>
					<tr>
						...
						<td>
							<p id="playlistnow_heart"><a href="#" class="playlistnow_white"><strong>♥</strong></a></p>
						</td>
					</tr>
				</tbody>
			</table>
